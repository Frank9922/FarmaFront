...
const formValidation = {
  ...
  password: [(value) => value.length > 3, 'La contraseña debe tener al menos 6 caracteres']
}
...
export const LoginPage = () => {
  ...
  const { email, emailValid, password, passwordValid, formState, isFormValid, onInputChange} = useForm(initialForm, formValidation);
    ...
    <AuthLayout>
      ...
      >      <form onSubmit={onSumbit}>
                ...
                <button disabled={ auth.estado === 'checking'} >
                        { auth.estado === 'checking' ? (<div className="spinner"></div>) : 'Iniciar Sesion' }
                    </button>
                </div>
