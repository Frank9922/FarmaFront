...
const formValidation = {
  nombre: [
    ...
    "El nombre debe ser mayor a tres caracteres",
  ],
  apellido: [
    (value) => value.length > 3,
    "El apellido debe ser mayor a tres caracteres",
  ],
  email: [(value) => value.includes("@"), "El correo debe tener una @"],
  password: [
    (value) => value.length > 6,
    "La contraseña debe ser mayor a ocho caracteres",
  ],
  re_password: [
    (value) => value.length > 6,
    "La contraseña debe ser mayor a ocho caracteres",
          ...
          <div className="body-form">
            <div className="datos">
              ...
              <input
                ...
                onChange={onInputChange}
                className={` ${
                  !!apellidoValid && formSubmitted ? "error" : ""
                }`}
              />
            </div>
            ...
            <input
              ...
              className={` ${
                !!passwordValid && formSubmitted && !passwordMatch
                  ? "error"
                  : ""
              }`}
            />
            ...
            <input
              ...
              className={` ${
                !!re_passwordValid && formSubmitted && !passwordMatch
                  ? "error"
                  : ""
              }`}
            />
            ...
            <div
              className={`error-form-alert ${
                !passwordMatch && formSubmitted ? "show" : ""
              }`}
            >
